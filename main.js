...
// Task 4
// Да, мы отработали запуск одной функции внутри другой,
// но сейчас мы чуть усложним задачу,
// чтобы вы понимали как можно вкладывать фукнции одна в другую. 
// Сразу оговорка, это ухудшает читабельность и разбор кода, пользуйтесь
// данным методом с умом. Сейчас мы создадим две фукнции hello которая выводит
// в out-4 текст 'Hello ' и f2021, которая будет запускать hello и выводить += 2021.
//  Эти функции уже написаны, ознакомьтесь с ними. 
//  Обратите внимание, они написаны внутри функции t4.
//   Почему? Потому что если мы просто их напишем в коде,
...
const box4 = document.querySelector('.out-4')

function hello() {  
        box4.innerHTML = 'Hello'
        console.log('3')
}
function f2021() {
    hello()
...
btn1.addEventListener('click', f4)
...
// Task 6
// Давайте усложним задачу. У нас есть функцию getRandomInt2 
// которая использует переменные min, max выводит в out-2 случайное целое число.
//  Напишите функцию t6, которая запускает getRandomInt2, после чего, получает из .
//  out-2 сгенерированное число и определяет четное оно или нет. Если четное,
//   запускает функцию even, если нет - odd. Обратите внимание, как написаны функции even, odd.
const out6 = document.querySelector('.out-6');
const out2Res = document.querySelector('.out-2');
function t6() {
    function odd() {
    ...
    function even() {
     ...
     function t5() {
        if(out2Res.textContent % 2 === 0){
            odd()
        } else {even()}
    }
    t5()
     console.log(out2Res.textContent)
...
// Task 8
// Дана переменная z8 равная 0. Напишите функцию t8, 
// которая при клике по .b-8 увеличивает z8 на единицу и запускает функцию showNumber. 
